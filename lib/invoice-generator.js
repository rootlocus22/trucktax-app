...
export async function generateInvoicePDF(payment, business, user) {
    try {
        ...
        y -= 12;
        drawText('support@vendaxsystemlabs.com', rightX, y, 9);
        y -= 12;
        ...
        // Footer
        y = 60;
        drawText('easyucr.com is a private technology service provider powered by Vendax Systems LLC.', 40, y, 8, font, rgb(0.5, 0.5, 0.5));
        y -= 12;
