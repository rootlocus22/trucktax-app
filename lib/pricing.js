 ...
 */
import { getServiceFeeFromConfig } from './pricing-config';
...
export const getServiceFee = (filingType, vehicleCount) => {
    // Standard Pricing Strategy driven by PRICING_CONFIG
    if (filingType === 'amendment') return 0.00; // "FREE VIN Corrections"

    return getServiceFeeFromConfig(filingType, vehicleCount);
};
