...
/**
 * Service fee for UCR Filing ($79, was $99) and UCR Pro ($99).
 */
export const UCR_SERVICE_PLANS = {
  filing: { name: 'UCR Filing Service', price: 79, originalPrice: 99, features: ['Fee calculation', 'Registration submission assistance', 'Confirmation tracking', 'Compliance record storage', 'Email proof archive'] },
