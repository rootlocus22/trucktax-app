...
export const BRACKET_COPY = {
  '1-2': {
    ...
    body: [
      ...
      'Brokers and freight forwarders pay the same $46 tier regardless of revenue; motor carriers with 1–2 trucks also pay this minimum. Add our filing service and you get all-inclusive pricing—one payment, we handle everything.',
    ],
  },
  '3-5': {
