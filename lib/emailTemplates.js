...
const TAGLINE_POSITIONING = 'All-inclusive pricing — one payment covers everything, government fee included.';
...
export function getWelcomeEmailTemplate({ displayName = '', email = '' }) {
  ...
  const content = `
    ...
    <ul style="margin: 16px 0; padding-left: 20px; color: ${TEXT};">
      ...
      <li><strong>All-inclusive pricing</strong> — one payment covers everything, government fee included</li>
...
export function getAbandonEmailTemplate({ firstName = '', email = '' }) {
  ...
  const content = `
    ...
    <ul style="margin: 16px 0; padding-left: 20px; color: ${TEXT};">
      ...
      <li>All-inclusive pricing — one payment covers everything, government fee included</li>
    </ul>
...
export function getFilingCompletedPayDownloadEmailTemplate({ legalName, filingId, amount = 79, email = '' }) {
  ...
  const content = `
    ...
    <p style="color: ${TEXT};"><strong>All-inclusive amount:</strong> ${amountDisplay} — government fee included, we handle the rest</p>
...
export function getUcrDeadlineReminderEmailTemplate({ firstName = '', registrantName = '', legalName = '', daysLeft = 14, email = '' }) {
  ...
  const content = `
    ...
    <p style="color: ${TEXT};">We make it simple: file in minutes with all-inclusive pricing. One payment covers everything — government fee included.</p>
