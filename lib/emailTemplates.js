...
const TAGLINE_POSITIONING = 'No upfront service fee — we only charge after your filing is complete.';

const BASE_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://www.quicktrucktax.com';
...
function buildFooter(recipientEmail) {
  ...
  <a href="mailto:support@quicktrucktax.com" style="color: ${ORANGE}; text-decoration: none;">support@quicktrucktax.com</a> · <a href="tel:+13478018631" style="color: ${ORANGE}; text-decoration: none;">+1 (347) 801-8631</a>
  ${unsubBlock}
  <br><br>
...
export function getWelcomeEmailTemplate({ displayName = '', email = '' }) {
  ...
  const content = `
    ...
    <ul style="margin: 16px 0; padding-left: 20px; color: ${TEXT};">
      ...
      <li><strong>No upfront service fee</strong> — we only charge after your certificate is ready to download</li>
