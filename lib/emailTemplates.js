...
export function getUCROutreachEmailTemplate({
  ...
  const subject = companyName
    ? `${companyName} — your 2026 UCR filing is due by December 31`
    : `2026 UCR compliance reminder — easyucr.com`;
  ...
  const content = `
    ...
    ${feeBlock}
    <p style="color: ${TEXT};">Filing with <strong style="color: ${NAVY};">${BRAND}</strong> is straightforward:</p>
