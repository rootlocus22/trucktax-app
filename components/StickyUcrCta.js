...
export default function StickyUcrCta() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-3 bg-[var(--color-midnight)] border-t border-white/10 shadow-lg">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3 text-white">
          <div className="w-10 h-10 rounded-full bg-[var(--color-orange)]/20 flex items-center justify-center">
        ...
        <Link
          href="/ucr/file"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[var(--color-orange)] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#e66a15] transition text-sm sm:text-base"
        >
