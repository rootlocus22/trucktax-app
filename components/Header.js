            ...
            {!user ? (
              ...
              <>
                ...
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-medium rounded-lg transition whitespace-nowrap ${isActive('/dashboard/upload-schedule1')
                    ? 'bg-white/20 text-white'
                    : 'text-white/90 hover:text-white hover:bg-white/10'
                    }`}
                >
                    ...
                    <>
                      ...
                      <div className="mt-2">
                        <div className="flex items-center gap-2 px-6 py-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">TRANSACTIONS</span>
                        </div>
                        <Link
                          href="/dashboard"
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive('/dashboard') && !isActive('/dashboard/schedule1') && !isActive('/dashboard/businesses') && !isActive('/dashboard/vehicles') && !isActive('/dashboard/filings') ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                            }`}
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                        ...
                        <Link
                          href="/dashboard/filings"
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive('/dashboard/filings') ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                            }`}
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <span style={{ color: 'white' }}>Filing List</span>
                        </Link>
                        <Link
                          href="/dashboard/schedule1"
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive('/dashboard/schedule1') ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                            }`}
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <span style={{ color: 'white' }}>Schedule 1</span>
                        </Link>
                        <Link
                          href="/dashboard/businesses"
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive('/dashboard/businesses') ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                            }`}
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <span style={{ color: 'white' }}>Businesses</span>
                        </Link>
                        <Link
                          href="/dashboard/vehicles"
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive('/dashboard/vehicles') ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                            }`}
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <span style={{ color: 'white' }}>Vehicles</span>
                        </Link>
                      </div>
                      ...
                      <div className="mt-6">
                        <div className="flex items-center gap-2 px-6 py-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">ACCOUNT</span>
                        </div>
                        <Link
                          href="/dashboard/profile"
                          onClick={() => setMobileMenuOpen(false)}
                          className="flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px]"
                          style={{ color: 'white', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        ...
                        {userData?.role === 'agent' && (
                          ...
                          >
                            ...
                            <span style={{ color: 'white' }}>Agent Portal</span>
                          </Link>
                        )}
                      </div>
                      ...
                      <div className="mt-6">
                        <div className="flex items-center gap-2 px-6 py-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">RESOURCES</span>
                        </div>
                        {navigation.resources.map((item) => (
                          <Link
                            key={item.href}
                            href={item.href}
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive(item.href) ? 'bg-white/10 border-l-4 border-[var(--color-sky)]' : ''
                              }`}
                            style={{ color: 'white', textDecoration: 'none' }}
                          >
                            <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="mt-6">
                        <div className="flex items-center gap-2 px-6 py-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">COMPLIANCE</span>
                        </div>
                        {navigation.compliance.map((item) => (
                          <Link
                            key={item.href}
                            href={item.href}
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive(item.href) ? 'bg-white/10 border-l-4 border-[var(--color-cyan)]' : ''
                              }`}
                            style={{ color: 'white', textDecoration: 'none' }}
                          >
                            <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="mt-6">
                        <div className="flex items-center gap-2 px-6 py-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">TOOLS</span>
                        </div>
                        {navigation.tools.map((item) => (
                          <Link
                            ...
                            href={item.href}
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center gap-4 px-6 py-3 hover:bg-white/10 active:bg-white/15 transition touch-manipulation min-h-[48px] ${isActive(item.href) ? 'bg-white/10 border-l-4 border-[var(--color-orange)]' : ''
                              }`}
                            style={{ color: 'white', textDecoration: 'none' }}
                          >
                            <svg className="w-6 h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
