              ...
              <>
                ...
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-medium rounded-lg transition whitespace-nowrap ${
                    isActive('/dashboard') && !isActive('/dashboard/schedule1') && !isActive('/dashboard/businesses') && !isActive('/dashboard/vehicles')
                    ...
                    <div className="mt-2">
                      ...
                      <Link
                        ...
                        className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                          isActive('/dashboard') && !isActive('/dashboard/schedule1') && !isActive('/dashboard/businesses') && !isActive('/dashboard/vehicles') ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-orange)]' : ''
                        }`}
                        style={{ color: '#1b2838', textDecoration: 'none' }}
                      >
                      ...
                      <Link
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                        className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                          isActive('/dashboard/schedule1') ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-orange)]' : ''
                        }`}
                        style={{ color: '#1b2838', textDecoration: 'none' }}
                      >
                        <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <Link
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                        className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                          isActive('/dashboard/businesses') ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-orange)]' : ''
                        }`}
                        style={{ color: '#1b2838', textDecoration: 'none' }}
                      >
                        <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <Link
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                        className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                          isActive('/dashboard/vehicles') ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-orange)]' : ''
                        }`}
                        style={{ color: '#1b2838', textDecoration: 'none' }}
                      >
                        <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-6">
                      ...
                      {navigation.resources.map((item) => (
                        <Link
                          ...
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                            isActive(item.href) ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-sky)]' : ''
                          }`}
                          style={{ color: '#1b2838', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-6">
                      ...
                      {navigation.compliance.map((item) => (
                        <Link
                          ...
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                            isActive(item.href) ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-cyan)]' : ''
                          }`}
                          style={{ color: '#1b2838', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-6">
                      ...
                      {navigation.tools.map((item) => (
                        <Link
                          ...
                          onClick={() => setMobileMenuOpen(false)}
                          className={`flex items-center gap-4 px-6 py-3 hover:bg-[var(--color-page-alt)] transition ${
                            isActive(item.href) ? 'bg-[var(--color-page-alt)] border-l-4 border-[var(--color-orange)]' : ''
                          }`}
                          style={{ color: '#1b2838', textDecoration: 'none' }}
                        >
                          <svg className="w-6 h-6" style={{ color: '#6b7280' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
