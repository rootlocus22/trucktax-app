      ...
      <div id="main-content" className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-8">
          ...
          <section>
            ...
            <p className="mt-4"><strong>QuickTruckTax is a private third-party provider.</strong> We are not the IRS, USDOT, FMCSA, or any government agency. We assist you in preparing and submitting UCR filings; you remain responsible for the accuracy of information and any government taxes or fees.</p>
          </section>
