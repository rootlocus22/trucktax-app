...
const months = [
    ...
    'July', 'August', 'September', 'October', 'March', 'December'
];
...
const faqs = [
    ...
    { q: 'Is Form 2290 required for 2026?', a: 'Yes, the tax period begins July 1, 2026. All heavy vehicles must file.' },
    ...
    { q: 'When is the 2290 deadline for 2026?', a: 'For vehicles on the road in July 2026, the deadline is August 31, 2026.' },
