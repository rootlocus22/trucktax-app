    ...
    <div className="min-h-screen bg-[var(--color-page)]">
      ...
      <section className="bg-gradient-to-r from-[var(--color-midnight)] to-[var(--color-navy-soft)] text-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 tracking-tight">Form 2290 Expert Blog</h1>
          <p className="text-lg sm:text-xl lg:text-[1.375rem] mb-6 max-w-3xl leading-relaxed">
